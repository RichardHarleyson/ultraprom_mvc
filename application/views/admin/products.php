...
<div class="collapse show mx-5" id="product_list">
	...
	<div class="input-group my-3">
		...
		<div class="form-group mx-3 w-25">
			...
			<select name="manufacturers" class="custom-select">
				<option value="0">. . .</option>
				<?php foreach ($manufacturers as $m){
			...
			<table class="table w-auto">
				...
				<tbody>
					<?php foreach ($products as $product) {
						...
						echo '
						<tr class="list_item" data-product_type="'.$product['category_id'].'" data-product_manufacturer="'.$product['manufacturer_id'].'">
						...
						'</td>'
						.'<td>
							<a  onclick="call_imgmodal_photo(this)" class="btn btn-primary mr-1 text-white" data-target="#modalIMG" data-toggle="modal" data-photo="'.$product['image'].'">
								<i class="fas fa-search"></i>
							</a>
							<label class="m-0 ml-1 text-white" for="file_'.$product['id'].'">
